...
description: Audit datasets for completeness, consistency, accuracy, and validity. Use when asked to profile data, detect anomalies or outliers, surface structural issues, or produce a data remediation plan.
---
