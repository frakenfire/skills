...
export const FORTUNE_TYPES: FortuneTypeMeta[] = [
  { key: 'tomorrow', label: '내일의 나', desc: '내일 하루 미리보기', cta: '내일쪽지 받기', icon: '🌅' },
  { key: 'month', label: '이번 달의 나', desc: '이번 달 전체 운세', cta: '이번달쪽지 받기', icon: '🗓️' },
  { key: 'love', label: '연애운', desc: '썸·연락·마음의 온도', cta: '연애쪽지 받기', icon: '💗' },
  { key: 'money', label: '돈운', desc: '지출·돈 기운', cta: '돈운쪽지 받기', icon: '🪙' },
