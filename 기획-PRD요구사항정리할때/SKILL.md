---
name: code-to-prd
description: Reverse-engineer any codebase into a complete Product Requirements Document (PRD). Use when asked to generate PRD, extract product specs from code, document page logic or API endpoints, or create a functional inventory from an existing codebase.
---
